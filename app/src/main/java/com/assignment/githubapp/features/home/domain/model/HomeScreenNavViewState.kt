...
sealed class Screen(val route: String, val title: String, @DrawableRes val icon: Int) {
    object Repositories :
        Screen(Navigator.Home.RepositoriesMain.route, "Home", R.drawable.ic_close_40px)

    object Profile : Screen(Navigator.Home.Profile.route, "Profile", R.drawable.ic_close_40px)
